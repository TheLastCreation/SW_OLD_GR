th_sword_blacksun_hack = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "",
	directObjectTemplate = "object/weapon/melee/2h_sword/th_sword_blacksun_hack.iff",
	craftingValues = {
		{"mindamage",47,96,0},
		{"maxdamage",100,188,0},
...
addLootItemTemplate("th_sword_blacksun_hack", th_sword_blacksun_hack)
