ghomrassen_matriarch_bantha_lair_neutral_large = Lair:new {
	mobiles = {{"bantha_matriarch",1},{"bantha",1}},
	spawnLimit = 15,
...
addLairTemplate("ghomrassen_matriarch_bantha_lair_neutral_large", ghomrassen_matriarch_bantha_lair_neutral_large)
