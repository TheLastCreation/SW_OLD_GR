ghomrassen_blacksun_assasin_neutral_large_theater = Lair:new {
	mobiles = {
		{"gr_black_sun_assassin",1},
		{"gr_black_sun_assassin_02",1},
		{"gr_black_sun_guard",1},
		{"gr_black_sun_thug",1}
	},
	spawnLimit = 15,
...
addLairTemplate("ghomrassen_blacksun_assasin_neutral_large_theater", ghomrassen_blacksun_assasin_neutral_large_theater)
