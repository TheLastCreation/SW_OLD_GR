...
--2H SWORDS
includeFile("items/weapon/2h_sword_battleaxe.lua")                         
includeFile("items/weapon/2h_sword_blacksun_hack.lua")                     
includeFile("items/weapon/2h_sword_cleaver.lua")                           
includeFile("items/weapon/2h_sword_katana.lua")                            
includeFile("items/weapon/2h_sword_katana_quest.lua")                      
includeFile("items/weapon/2h_sword_maul.lua")                              
includeFile("items/weapon/2h_sword_scyth.lua")   
includeFile("items/weapon/2h_sword_avatar_wke_toothpick.lua")
includeFile("items/weapon/2h_sword_avatar_wke_toothpick2.lua")
includeFile("items/weapon/2h_sword_battleaxe_npe.lua")
includeFile("items/weapon/2h_sword_battleaxe_quest.lua")
...
includeFile("items/weapon/th_sword_wod_scyth.lua")
includeFile("items/weapon/th_sword_wod_sword.lua")
